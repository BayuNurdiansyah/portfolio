...
<div class="container page-wrapper">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <p class="section-title mb-0">Kelola Tech Stack</p>
    ...
    <table class="table table-dark table-hover mb-0" style="background:transparent">
      ...
      <tbody>
        ...
        <tr style="border-color:rgba(224,0,0,0.15)">
          <td class="px-4"><?= $no++ ?></td>
          <td>
            <img src="<?= htmlspecialchars($logo) ?>" alt="<?= htmlspecialchars($row['nama']) ?>"
                 style="width:32px;height:32px;object-fit:contain;"
                 onerror="this.src='https://via.placeholder.com/32x32/1a1a1a/e00000?text=?'">
          </td>
          <td><?= htmlspecialchars($row['nama']) ?></td>
          <td><span class="skill-badge skill-mahir" style="font-size:.7rem;"><?= htmlspecialchars($row['kategori']) ?></span></td>
