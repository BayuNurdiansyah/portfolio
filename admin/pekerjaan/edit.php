...
<?php
$id  = (int)$_GET['id'];
$row = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM pekerjaan WHERE id=$id"));
...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  mysqli_query($conn,"UPDATE pekerjaan SET perusahaan='$perusahaan',posisi='$posisi',
    tahun_masuk=$tahun_masuk,tahun_keluar='$tahun_keluar',deskripsi='$deskripsi' WHERE id=$id");
...
<div class="container page-wrapper">
  <p class="section-title">Edit Pekerjaan</p>
    ...
    <div class="card-dark">
      <form method="POST">
        <div class="mb-3">
          ...
          <input type="text" name="perusahaan" class="form-control admin-input" value="<?= htmlspecialchars($row['perusahaan']) ?>" required>
        </div>
        <div class="mb-3">
        ...
        <div class="row g-3 mb-3">
          ...
          <div class="col">
            ...
            <input type="text" name="tahun_keluar" class="form-control admin-input" value="<?= htmlspecialchars($row['tahun_keluar']) ?>">
          </div>
        </div>
        <div class="mb-4">
          <label class="form-label text-main small">DESKRIPSI</label>
          <textarea name="deskripsi" class="form-control admin-input" rows="3"><?= htmlspecialchars($row['deskripsi']) ?></textarea>
        </div>
